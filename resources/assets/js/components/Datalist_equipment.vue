<template>
    <div style="width:100%;position:relative;">
        ...
        <!-- <el-date-picker v-model="value4" type="datetimerange" :picker-options="pickerOptions2" range-separator="至" start-placeholder="开始日期"
            end-placeholder="结束日期" align="right" @change="chooseTimer">
        </el-date-picker> -->
        ...
        <div class="block">
            <!-- 没有时间的页数 -->
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange1" :current-page.sync="currentPage1" :page-size="5"
                layout="total,prev, pager, next, jumper" :total="total1">
                <!-- :class="{hidden:value4[0]}" -->
            </el-pagination>
            <!-- 绑定的是有时间限制的页数 -->
            <!-- <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange2" :current-page.sync="currentPage2" :page-size="5"
                layout="prev, pager, next, jumper" :total="page2" :class="{hidden:!value4[0]}">
            </el-pagination> -->
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.$http
                    .get(path + "admin/sweeper-license/", {
                        params: {
                            device_uuid: this.$route.params.deviceUuid.device_uuid,
